...
HD_PWD='C:/Users/peter/Desktop/Elec Bsc/4th semester/SPRO4/Fifo_to_oled_v3/Oled_boyy/Oled_boyy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mejn.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mejn.tcl -notrace
